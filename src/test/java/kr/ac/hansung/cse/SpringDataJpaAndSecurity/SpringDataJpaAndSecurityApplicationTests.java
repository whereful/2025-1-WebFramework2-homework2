...
@SpringBootTest
@Transactional
class SpringDataJpaAndSecurityApplicationTests {

    @Autowired
    private ProductRepository productRepository;

    private static final Logger logger = LoggerFactory.getLogger(SpringDataJpaAndSecurityApplicationTests.class);
